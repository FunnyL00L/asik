...
import 'package:asik/models/erorrmsg.dart';
import 'package:asik/models/kelompok_tani_model.dart';
...
Future<Petani> createPetani(Petani petani) async {
    try {
      var pickedFile = await ImagePicker().getImage(source: ImageSource.gallery); // Mengambil foto dari galeri
